...
public class ReadMoreIMDTextView extends TextView {
    ...
    public ReadMoreIMDTextView(Context context) {
        this(context, null);
    }

    public ReadMoreIMDTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
